...
import annotate.input.parsers.line.concrete.EnsemblSnpParser;

/**
 * @author jaschasilbermann
 *
 */
public class EnsemblSnpFileToDB {
	...
	public static void main(String[] args) {
		...
		SimpleFileParser file_parser = new SimpleFileParser( file_name, new EnsemblSnpParser() );
